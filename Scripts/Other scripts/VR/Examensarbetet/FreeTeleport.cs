...
namespace Valve.VR.InteractionSystem
{
	...
	public class FreeTeleport : MonoBehaviour
	{
		...
		//-------------------------------------------------
		private static FreeTeleport _instance;
		public static FreeTeleport instance
		{
			get
			{
				if (_instance == null)
				{
					_instance = GameObject.FindObjectOfType<FreeTeleport>();
				}
		...
		private void InitiateTeleportFade()
		{
			...
			//The commented out code is for if this would have a fade time/delay
