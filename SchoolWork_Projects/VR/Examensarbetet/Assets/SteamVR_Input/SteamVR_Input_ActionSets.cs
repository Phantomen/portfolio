...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_MotionSickness p_MotionSickness;
        ...
        public static SteamVR_Input_ActionSet_MotionSickness MotionSickness
        {
            get
            {
                return SteamVR_Actions.p_MotionSickness.GetCopy<SteamVR_Input_ActionSet_MotionSickness>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_MotionSickness = ((SteamVR_Input_ActionSet_MotionSickness)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_MotionSickness>("/actions/MotionSickness")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.MotionSickness};
        }
    }
}
